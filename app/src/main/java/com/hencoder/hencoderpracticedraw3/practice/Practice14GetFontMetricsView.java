...
public class Practice14GetFontMetricsView extends View {
...

    {
        ...
        middle = (fontMetrics.descent + fontMetrics.ascent) / 2;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(texts[0], 100, middle - this.middle, paint2);
        canvas.drawText(texts[1], 200, middle - this.middle, paint2);
        canvas.drawText(texts[2], 300, middle - this.middle, paint2);
        canvas.drawText(texts[3], 400, middle - this.middle, paint2);
        canvas.drawText(texts[4], 500, middle - this.middle, paint2);
        canvas.drawText(texts[5], 600, middle - this.middle, paint2);
    }
}
